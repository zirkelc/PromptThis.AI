...
function setMarkdown(element, text) {
    return __awaiter(this, void 0, void 0, function* () {
        element.innerHTML = yield marked.parse(text);
...
const promptTextInput = getElementById('prompt');
...
function loadPrompt() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (currentPrompt.type === ApiTypes.SUMMARIZER) {
            ...
            setValue(summaryLengthInput, ((_f = (_e = currentPrompt.options) === null || _e === void 0 ? void 0 : _e.summarizer) === null || _f === void 0 ? void 0 : _f.length) || SummaryLengths.SHORT);
        }
...
function submitPrompt() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        scrollDown();
        let options = {};
        if ((currentPrompt === null || currentPrompt === void 0 ? void 0 : currentPrompt.type) === ApiTypes.SUMMARIZER) {
            options = {
        ...
        try {
            currentSession = yield createSession(currentPrompt.type, options);
            console.log('currentSession', { currentSession });
            const stream = yield createStream(currentSession, prompt);
            try {
                // @ts-ignore
